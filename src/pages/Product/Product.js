...
class ProductPage extends Component {
  ...
  fetchData = () => {
    ...
    mongodb.db('shop').collection('products').find({_id: new BSON.ObjectID(this.props.match.params.id)}).asArray()
    .then(productResponse => {
      productResponse[0]._id = productResponse[0]._id.toString();
      productResponse[0].price = productResponse[0].price.toString();
